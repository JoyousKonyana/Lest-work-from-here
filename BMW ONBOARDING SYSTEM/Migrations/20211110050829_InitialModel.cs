        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EquipmentQueryDescription = table.Column<string>(unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueryStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquipmentId = table.Column<int>(nullable: false),
                    OnboarderID = table.Column<int>(nullable: false),
                    QueryStatusId = table.Column<int>(nullable: false),
                    EquipmentQueryDescription = table.Column<string>(unicode: false, nullable: true),
                    EquipmentQueryDate = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentQuery", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EquipmentQuery_Equipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipment",
                        principalColumn: "EquipmentID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentQuery_Onboarder_OnboarderID",
                        column: x => x.OnboarderID,
                        principalTable: "Onboarder",
                        principalColumn: "OnboarderID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentQuery_QueryStatus_QueryStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentQuery_OnboarderID",
                table: "EquipmentQuery",
                column: "OnboarderID");

            migrationBuilder.CreateIndex(
                name: "IX_EquipmentQuery_QueryStatusId",
                table: "EquipmentQuery",
